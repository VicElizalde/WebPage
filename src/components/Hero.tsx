...
export default function Hero() {
  return (
    <section id="hero" className="bg-bg-light min-h-[100dvh] pt-32 pb-16 flex items-center">
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="flex flex-col gap-6">
          <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-dark leading-[1.1] tracking-tight">
            <span className="block lg:whitespace-nowrap">Escucha para tu mente,</span>
            <span className="text-primary block lg:whitespace-nowrap">cambio para tu vida</span>
          </h1>
          
          <p className="text-body text-base lg:text-lg leading-relaxed max-w-xl">
            Atención psicológica profesional y humana para abordar los desafíos de la vida y descubrir nuevos recursos internos.
          </p>
